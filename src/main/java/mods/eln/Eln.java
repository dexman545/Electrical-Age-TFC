...
public class Eln {
	...
	public void load(FMLInitializationEvent event) {
		...
		MinecraftForge.EVENT_BUS.register(new TFCEvents());
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		QuernManager quernmgr = QuernManager.getInstance();
		for (QuernRecipe recipe : quernmgr.getRecipes())
			maceratorRecipes.addRecipe(new Recipe(recipe.getInItem(), recipe.getResult(), 4000));
	...
	void registerElectricalTool(int id) {
...

		{
			...
			ElectricalPickaxe desc = new ElectricalPickaxe(
					name,
					40, 3,// float strengthOn,float strengthOff,
...

		{
			...
			ElectricalAxe desc = new ElectricalAxe(
					name,
					60, 3,// float strengthOn,float strengthOff,
					40000, 200, 800// double energyStorage,double
									// energyPerBlock,double chargePower
			);
			sharedItemStackOne.addElement(subId + (id << 6), desc);
	...
	void recipePlateMachine() {
		...
		plateMachineRecipes.addRecipe(new Recipe(
				findItemStack("Copper Ingot", 2),
				findItemStack("Copper Plate"), 1.0 * f));

		plateMachineRecipes.addRecipe(new Recipe(findItemStack("Lead Ingot", 2),
		...
		plateMachineRecipes.addRecipe(new Recipe(new ItemStack(Items.iron_ingot, 2,
				0), findItemStack("Iron Plate"), 1.0 * f));

		plateMachineRecipes.addRecipe(new Recipe(new ItemStack(Items.gold_ingot, 2,
