...
public class AutoMinerSlowProcess implements IProcess, INBTTReady {
	...
	boolean checkIsOre(Coordonate coordonate) {
		...
		if (block instanceof com.bioxx.tfc.Blocks.Terrain.BlockOre)
			return true;
		if (block instanceof com.bioxx.tfc.Blocks.Terrain.BlockOre2)
			return true;
		if (block instanceof com.bioxx.tfc.Blocks.Terrain.BlockOre3)
			return true;
